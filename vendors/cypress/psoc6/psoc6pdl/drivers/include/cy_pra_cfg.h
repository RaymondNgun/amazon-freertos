...
typedef struct
{
    ...
    cy_en_syspm_ldo_mode_t ldoMode;                     /**< LDO Mode */
    cy_en_syspm_buck_voltage1_t buckVoltage;            /**< Buck Voltage */

    /* System clocks */
    /* IMO is always enabled */
    /* ECO Configuration */
    /* TODO: Since ECO is disabled, can we remove these ECO config? */
    ...
    /* FLL Configuration */
    uint32_t fllOutFreq;                                /**< FLL Output Frequency in Hz */
    ...
    /* PLL0 Configuration */
    uint32_t pll0OutFreq;                               /**< PLL0 output frequency in Hz */
    ...
    /* PLL1 Configuration */
    uint32_t pll1OutFreq;                               /**< PLL1 output frequency in Hz */
